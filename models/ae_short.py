...
class small_autoencoder(nn.Module):
    def __init__(self, args):
        ...
        self.enc_layer_small = nn.Sequential(
            nn.Conv2d(128, 64, kernel_size=3, stride=2), # b, 64, 13, 10
        )
        #encode only t
        ...
        self.dec_layer_small = nn.Sequential(
            nn.ConvTranspose2d(64, 64, kernel_size=3, stride=2, output_padding=(0,1)),  # b, 64, 27, 22
            nn.InstanceNorm2d(64),
            nn.ReLU(True),
        )
